...
const ListRoles = () => {
  ...
  }, [backend_url, token, rolePage, pageLimit, searchValue]);
        ...
        <td colSpan="12">
          <div className="flex justify-center items-center h-[300px] w-full">
            <div className="flex flex-col">
              ...
              <p className="text-[#ADADAD] text-sm mt-5">No Role yet</p>
            </div>
          </div>
        </td>
      </tr>
        ...
        <div className="flex flex-row justify-between items-center py-3">
          <div className="flex flex-row items-start gap-2">
            ...
            <p className="text-[#6E6E6E] font-roboto text-[15px] font-normal leading-normal">
              Tip search by Role ID: Each product is provided with a unique ID,
        ...
        {roles.meta && (
          <div className="flex flex-row text-center justify-between my-5">
            <p className="text-sm text-gray-500">
              Showing {roles.meta.currentPage} to {roles.meta.totalPages} of{" "}
              {roles.meta.totalItems} entries
            </p>
