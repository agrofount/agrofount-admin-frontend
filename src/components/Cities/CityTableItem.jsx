  ...
  return (
    <tr className="hover:bg-[#F7F7F7]">
      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
        <p className="py-1">{city.id.slice(0, 10)}</p>
      </td>
      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
      ...
      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
        <p className="py-1">
          <p className="py-1">{city.code}</p>
        </p>
      </td>

      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
        <p className="py-1">{new Date(city.createdAt).toDateString()}</p>
      </td>

      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
        <p
          className={`py-1 ${
            city.isActive ? "bg-[#61BF75]" : "bg-[#F96767]"
      ...
      <td className="px-4 py-5 whitespace-nowrap text-sm text-gray-500">
        <div className="flex flex-row gap-3 items-center">
          <Link
            to={`/cities/${city.id}/edit?countryId=${city.state.country.id}&stateId=${city.state.id}`}
          >
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Are you sure you want to delete your {city.name}?
