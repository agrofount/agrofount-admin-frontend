...
const RoleTableItem = ({ role, setItemDeleted }) => {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`${backend_url}/role/${role.id}`, {
        headers: {
  ...
  return (
    <tr className="hover:bg-[#F7F7F7]">
      ...
      <td className="px-2 py-5 whitespace-nowrap text-sm text-gray-500">
        <p className="py-1">{new Date(role.createdAt).toDateString()}</p>
      </td>
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Are you sure you want to delete your {role.name}?
